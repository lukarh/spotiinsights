...
const ArtistItemAlt = (item, index) => {
    return (
        <div className="row" style={{ display: "flex", flexDirection: "row", alignItems: "center", paddingBottom: "0.5rem", zIndex: "3" }} key={item.name}>

            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "5%", paddingLeft: "1.75rem", paddingRight: "1.75rem", marginLeft: "auto" }}>
                {index+1}
            </div>
            ...
            <a href={item.external_urls['spotify']} target="_blank" rel="noreferrer" style={{ zIndex: 3, paddingRight: "1.25rem" }} >
