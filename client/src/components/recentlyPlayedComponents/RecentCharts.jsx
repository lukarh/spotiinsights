...
const RecentCharts = ({ recentPlaylist }) => {
    ...
    const BPM_FOOTER = "A BPM Monitor of your 50 most recently played songs. BPM stands for Beats per Minute and indicates the tempo and pace of a song or piece of music."

    const HAPPINESS_TITLE = "Your Song Mood Swings. 🥴"
    const HAPPINESS_FOOTER = "Per Spotify's API, they assign each song a 'valence' rating from 0.0 to 1.0. Low valence is associated with negative emotions, while high valence associating with positive emotions."

    return (
        <Stack className='padding-1-rem' spacing={5}>
