...
const Callback = () => {
    ...
    return (
        <div className="background" style={{ display: "flex", justifyContent: "center", paddingTop: "4rem", paddingBottom: "4rem", height: "100%" }}>

            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", width: "30%" }}>

                <h1 style={{ marginBottom: "5rem", textAlign: "center" }}>Performing a vibe check on your Spotify...</h1>
