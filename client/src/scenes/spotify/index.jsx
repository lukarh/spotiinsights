        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingTop: "2rem", paddingBottom: "2rem" }}>
                    ...
                    <p>
                        SpotiInsights was developed as an open source app powered by Spotify's Web API. By choosing to use this app, you agree to the use of your Spotify
                        Account username and data for your top artists and tracks.
                    </p>
                    <p>
                        SpotiInsights does not store or collect your data anywhere, and is also not shared with any third parties. All information is used solely for displaying 
                        your insights on the webpage for your viewing.
                    </p>
                    <p>
                        You can revoke SpotiInsights's permissions to your Spotify Account & Data by 
                        ...
                        </a> and clicking "REMOVE ACCESS" for SpotiInsights.
                    </p>
